...
**Bug**
 ...
 - 최종 제출 오류
 - 기업 페이지 > 채용공고 > 지원서 작성
 - 채용 홈페이지 → 지원서 작성: 지원서 불러오기 증명사진 오류

<br>

**UI 개선**
 - 1:1 문의 제출 후 화면 전환 개선
 - 기업 페이지: 화면 줄어들 시 메뉴 하위 아이콘 보이게 처리
 - 기업 페이지 화면 비율에 따라 이미지 축소
...
**Bug**
 - 채용 공고문 작성 에디터 기능 오류
 - 기업 페이지 → 채용 관리 → 필기 전형 → 전형 기간 설정 시 오류
 - 기업 페이지 → 채용 관리 → 필기 전형: 응시 안내 메일 발송 오류
 - 기업 페이지 → 채용 관리 → 면접 전형 → 평가실: 엑셀 등록 시 저장 문제 오류
 - 기업 페이지 → 채용 관리 → 필기 전형 → 발송 → E-mail(지원자) 메일 발송 오류
...
**UI 개선**
 - 기업 담당자 > 보관함 > 필기도구 > 필기도구 등록 팝업에 도구 코드 열 추가
 - 기업 페이지 > 채용 관리 > 서류 전형: 서류 접수 기간
 - 사용자 등록 팝업 수정
...
- ![기업 페이지채용공고지원서 작성](https://github.com/user-attachments/assets/6dbf44a1-bf0b-4511-af1a-8e5bb635ebb5)
...
### 작업 소요기간 : 1일
- ![res_채용홈페이지_반응형](https://github.com/user-attachments/assets/e991fa44-a306-4142-8534-84ed0722f747)
...
# 14. 기업페이지 -> 채용관리 -> 필기전형 : 응시안내 메일발송 오류
...
### 해결일자 :
### 작업 소요기간 : 
![image](https://github.com/user-attachments/assets/858c9666-4cde-4784-9380-f02145a98c11)
"응시 안내 메일발송" 클릭 시 아무런 반응이 없음  <br>
응시자들 선택 혹은 미선택을 해도 동일하게 아무런 반응이 없음 <br>
응시자들에게 선택(1명 이상)을 하고 선택된 응시자들만 보내든가, 아니면 전부 발송해야 함

<br>

## 14-2 원인
1. 아무런 반응이 없는 이유 "응시 기간"을 설정하지 않은 상태에서 클릭했기 때문, 설정하지 않은 경우 msg를 보내야 함


<br>


# 15. 기업 페이지 → 채용 관리 → 면접 전형 → 평가실: 엑셀 등록 시 저장 문제 오류
